            ...
            <div class="box">
              ...
              if (isset($_POST['add_cart'])) {
                ...
                if (mysqli_num_rows($run_check) > 0) {
                  ...
                  $query = "insert into cart (p_id,ip_add,qty,p_price,size,seller_id) values ('$p_id','$ip_add','$product_qty','$product_price','$product_size','$seller_id')";
