...
if (isset($_POST['submit'])) {
    ...
    $sel_old_pass = "select * from wholesaler where wholesaler_email='$c_email'";
    ...
    $update_pass = "update wholesaler set wholesaler_pass='$password_set' where wholesaler_email='$c_email'";
