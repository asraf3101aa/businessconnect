  ...
  <div id="content">
    ...
    <div class="container">
      ...
      <div class="col-md-12">
        ...
        $wholesaler_confirm_code = $row_customer['wholesaler_confirm_code'];

        $c_name = $row_customer['wholesaler_name'];

        if (!empty($wholesaler_confirm_code)) {
      ...
      <div class="col-md-9">
        ...
        <div class="box">
          ...
          if (isset($_GET[$wholesaler_confirm_code])) {

            $update_customer = "update wholesaler set wholesaler_confirm_code='' where wholesaler_confirm_code='$wholesaler_confirm_code'";
